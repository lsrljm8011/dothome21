                            ...
                            <form action="boardModifySave.php" name="boardModify" method="post">
                                <fieldset>
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT b.boardTitle, b.boardContent, b.boardView, m.youName FROM myBoard b JOIN myMember m ON (b.myMemberID = m.myMemberID) WHERE b.myBoardID = {$boardID}";
